...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'OrderDayItem.user'
        raise RuntimeError("Cannot reverse this migration. 'OrderDayItem.user' and its values cannot be restored.")
