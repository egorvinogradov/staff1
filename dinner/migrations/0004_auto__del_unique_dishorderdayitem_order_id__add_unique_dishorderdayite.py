...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'DishOrderDayItem', fields ['order', 'id']
        db.delete_unique('dinner_dishorderdayitem', ['order_id', 'id'])

        # Adding unique constraint on 'DishOrderDayItem', fields ['dish_day', 'order']
        db.create_unique('dinner_dishorderdayitem', ['dish_day_id', 'order_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'DishOrderDayItem', fields ['dish_day', 'order']
        db.delete_unique('dinner_dishorderdayitem', ['dish_day_id', 'order_id'])

        # Adding unique constraint on 'DishOrderDayItem', fields ['order', 'id']
        db.create_unique('dinner_dishorderdayitem', ['order_id', 'id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 43, 40, 802775)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 43, 40, 802664)'}),
        ...
        'dinner.restaurnatorderdayitem': {
            'Meta': {'unique_together': "(('order', 'id'),)", 'object_name': 'RestaurnatOrderDayItem'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dinner.Order']"}),
