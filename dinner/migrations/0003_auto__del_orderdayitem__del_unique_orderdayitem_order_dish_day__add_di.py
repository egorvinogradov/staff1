...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DishOrderDayItem'
        db.create_table('dinner_dishorderdayitem', (
        ...
        db.send_create_signal('dinner', ['DishOrderDayItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DishOrderDayItem'
        db.delete_table('dinner_dishorderdayitem')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 42, 43, 234880)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 42, 43, 234774)'}),
        ...
        'dinner.dishorderdayitem': {
            'Meta': {'unique_together': "(('order', 'id'),)", 'object_name': 'DishOrderDayItem'},
