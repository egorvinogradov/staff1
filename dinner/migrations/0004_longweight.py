...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Dish.weight'
        db.alter_column('dinner_dish', 'weight', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))


    def backwards(self, orm):
        
        # Changing field 'Dish.weight'
        db.alter_column('dinner_dish', 'weight', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
