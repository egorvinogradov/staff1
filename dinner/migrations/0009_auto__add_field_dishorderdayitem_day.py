...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DishOrderDayItem.day'
        db.add_column('dinner_dishorderdayitem', 'day', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dinner.Day']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DishOrderDayItem.day'
        db.delete_column('dinner_dishorderdayitem', 'day_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 16, 50, 53, 496244)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 16, 50, 53, 496106)'}),
