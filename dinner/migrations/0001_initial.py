...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dinner_menu', (
            ('week', self.gf('django.db.models.fields.DateField')(unique=True, primary_key=True)),
        ...
        db.create_table('dinner_day', (
            ...
            ('week', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dinner.Menu'])),
        ...
        db.create_table('dinner_order', (
            ...
            ('menu', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['dinner.Menu'])),
        ...
        # Adding unique constraint on 'Order', fields ['user', 'menu']
        db.create_unique('dinner_order', ['user_id', 'menu_id'])
        ...
        # Adding unique constraint on 'OrderDayItem', fields ['order', 'dish']
        db.create_unique('dinner_orderdayitem', ['order_id', 'dish_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'OrderDayItem', fields ['order', 'dish']
        db.delete_unique('dinner_orderdayitem', ['order_id', 'dish_id'])

        # Removing unique constraint on 'Order', fields ['user', 'menu']
        db.delete_unique('dinner_order', ['user_id', 'menu_id'])
