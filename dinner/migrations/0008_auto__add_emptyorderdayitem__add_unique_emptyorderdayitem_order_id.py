...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EmptyOrderDayItem'
        db.create_table('dinner_emptyorderdayitem', (
        ...
        db.send_create_signal('dinner', ['EmptyOrderDayItem'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'EmptyOrderDayItem'
        db.delete_table('dinner_emptyorderdayitem')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 16, 11, 9, 772046)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 16, 11, 9, 771928)'}),
        ...
        'dinner.emptyorderdayitem': {
            'Meta': {'unique_together': "(('order', 'id'),)", 'object_name': 'EmptyOrderDayItem'},
            'day': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dinner.Day']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'order': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['dinner.Order']"})
        },
