...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Menu.provider'
        db.add_column('dinner_menu', 'provider', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dinner.Provider']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Menu.provider'
        db.delete_column('dinner_menu', 'provider_id')
