...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Week.closed'
        db.add_column('dinner_week', 'closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Week.closed'
        db.delete_column('dinner_week', 'closed')
