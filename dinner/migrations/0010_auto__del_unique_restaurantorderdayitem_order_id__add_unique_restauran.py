...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'EmptyOrderDayItem', fields ['order', 'id']
        db.delete_unique('dinner_emptyorderdayitem', ['order_id', 'id'])
        ...
        # Adding unique constraint on 'RestaurantOrderDayItem', fields ['order', 'day']
        db.create_unique('dinner_restaurantorderdayitem', ['order_id', 'day_id'])

        # Adding field 'EmptyOrderDayItem.field'
        db.add_column('dinner_emptyorderdayitem', 'field', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Adding unique constraint on 'EmptyOrderDayItem', fields ['order', 'day']
        db.create_unique('dinner_emptyorderdayitem', ['order_id', 'day_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EmptyOrderDayItem', fields ['order', 'day']
        db.delete_unique('dinner_emptyorderdayitem', ['order_id', 'day_id'])

        # Removing unique constraint on 'RestaurantOrderDayItem', fields ['order', 'day']
        db.delete_unique('dinner_restaurantorderdayitem', ['order_id', 'day_id'])
        ...
        # Deleting field 'EmptyOrderDayItem.field'
        db.delete_column('dinner_emptyorderdayitem', 'field')

        # Adding unique constraint on 'EmptyOrderDayItem', fields ['order', 'id']
        db.create_unique('dinner_emptyorderdayitem', ['order_id', 'id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 17, 1, 27, 683143)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 17, 1, 27, 683034)'}),
