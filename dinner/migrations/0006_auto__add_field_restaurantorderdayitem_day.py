...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RestaurantOrderDayItem.day'
        db.add_column('dinner_restaurantorderdayitem', 'day', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['dinner.Day']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RestaurantOrderDayItem.day'
        db.delete_column('dinner_restaurantorderdayitem', 'day_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 47, 7, 690814)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 3, 4, 47, 7, 690707)'}),
