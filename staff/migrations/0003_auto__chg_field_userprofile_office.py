...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('staff_userprofile', 'office_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['staff.Office'], null=True))
    ...
    models = {
        ...
        'staff.userprofile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'office': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['staff.Office']", 'null': 'True'}),
